...
namespace Notify.Interfaces
{
    public interface IAsyncNotificationClient : IBaseClient
    {
        ...
        Task<MessageBoxNotificationResponse> SendMessageBoxNotificationAsync(string recipient, string message, string messageType, string subject = null, IEnumerable<Attachment> attachments = null, string reference = null);
